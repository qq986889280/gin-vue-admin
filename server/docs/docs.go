    ...
    "paths": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_flipped-aurora_gin-vue-admin_server_plugin_ucenter_model.Request"
                        }
                    }
                ],
                "responses": {
        ...
        "/faCaiwu/createFaCaiwu": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "创建FaCaiwu",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/user.FaCaiwu"
                        }
                    }
                ],
                "responses": {
        ...
        "/faCharge/createFaCharge": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "创建FaCharge",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/charge.FaCharge"
                        }
                    }
                ],
                "responses": {
        ...
        "/faShang/createFaShang": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "创建FaShang",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/charge.FaShang"
                        }
                    }
                ],
                "responses": {
        ...
        "/faUser/createFaUser": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "创建FaUser",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/user.FaUser"
                        }
                    }
                ],
                "responses": {
        ...
        "/faUserLevel/createFaUserLevel": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "创建FaUserLevel",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/user.FaUserLevel"
                        }
                    }
                ],
                "responses": {
        ...
        "/faUserLevel/deleteFaUserLevelByIds": {
            "delete": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/faUserLevel/getFaUserLevelList": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/videoDetails/createVideoDetails": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "创建VideoDetails",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/video.VideoDetails"
                        }
                    }
                ],
                "responses": {
        ...
        "/videoDetails/deleteVideoDetailsByIds": {
            "delete": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/videoDetails/getVideoDetailsList": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
    ...
    "definitions": {
        ...
        "config.Server": {
            ...
            "properties": {
                ...
                "baosms": {
                    "$ref": "#/definitions/github_com_flipped-aurora_gin-vue-admin_server_config.BaoSms"
                },
                "captcha": {
        ...
        "github_com_flipped-aurora_gin-vue-admin_server_config.BaoSms": {
            "type": "object",
            "properties": {
                "password": {
                    "description": "密码",
        ...
        "github_com_flipped-aurora_gin-vue-admin_server_plugin_ucenter_model.Request": {
            "type": "object",
            "properties": {
                "captcha": {
                    "description": "验证码",
