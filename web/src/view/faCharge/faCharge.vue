  ...
  <div>
    <div class="gva-search-box">
      <el-form :inline="true" :model="searchInfo" class="demo-form-inline">
        ...
        <el-form-item label="商户id:">
          <el-input v-model.number="searchInfo.shangId" :clearable="true" placeholder="请输入" />
        </el-form-item>
        <el-form-item label="订单号:">
          <el-input v-model="searchInfo.orderSn" :clearable="true" placeholder="请输入" />
        </el-form-item>
        <el-form-item>
    ...
    <div class="gva-table-box">
      ...
      >
        ...
        <el-table-column align="left" label="按钮组" width="155">
        ...
        <el-table-column align="left" label="通知状态" prop="notice" width="80">
          <template #default="scope">
